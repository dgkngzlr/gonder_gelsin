...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_4.setGeometry(QtCore.QRect(70, 170, 300, 50))
        self.label_4.move(70,350)
        self.label_4.setObjectName("label_4")

        self.label_5 = QtWidgets.QLabel(self.tab)
        self.label_5.setGeometry(QtCore.QRect(10, -80, 300, 50))
        self.label_5.move(10,100)
        self.label_5.setObjectName("label_5")
        str_ip = self.get_host_IP()
        self.label_5.setText(f'Bu Bilgisayarın IP : {str_ip} ')
